class TextScrollRideComponent extends HTMLElement {
  constructor() {
    super();
  ...
  async loadTemplate() {
    try {
      const response = await fetch("text-scroll-ride.html");
      const html = await response.text();
      const parser = new DOMParser();
      const doc = parser.parseFromString(html, "text/html");
      const template = doc.getElementById("text-scroll-ride-template");
...
customElements.define("text-scroll-ride", TextScrollRideComponent);
